        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="flex flex-col gap-8 lg:max-w-xl">
            ...
            <p className="text-lg leading-8 text-zinc-600 dark:text-zinc-400">
              The most reliable printing business in Huntington Beach. SNF Forms
              has been facilitating the health care industry for over 30 years.
              We provide the easiest access to a variety of medical forms and
